...
public class Main {
	...
	public static void main(String[] args) {
		...
		ArrayList<Pessoa> pessoas = new ArrayList<Pessoa>();
			...
			Estudante estudante03 = new Estudante("Kalinne", "Second st.");
			estudante03.addCursoNota("Historia", 10);
			estudante03.addCursoNota("Matematica", 9);
			estudante03.addCursoNota("Informatica", 9);
			estudante03.addCursoNota("Biologia", 10);
			pessoas.add(estudante01);
			pessoas.add(estudante02);
			pessoas.add(estudante03);

			Professor  professor01 = new Professor("Augusto", "Fourth st.");
			professor01.addCurso("matematica");
			professor01.addCurso("biologia");
			
			Professor professor02 = new Professor("João", "First st.");
